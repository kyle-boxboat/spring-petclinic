...
:DEFAULT_REGISTRY
    ...
    SET REGISTRY_NAMESPACE=parodos
	GOTO DOCKER_CONTAINER_RUNTIME
...
echo "pushing image spring-petclinic"
%CONTAINER_RUNTIME% tag spring-petclinic %REGISTRY_URL%/%REGISTRY_NAMESPACE%/spring-petclinic
%CONTAINER_RUNTIME% push %REGISTRY_URL%/%REGISTRY_NAMESPACE%/spring-petclinic

echo "pushing image spring-petclinic-buildstage"
%CONTAINER_RUNTIME% tag spring-petclinic-buildstage %REGISTRY_URL%/%REGISTRY_NAMESPACE%/spring-petclinic-buildstage
%CONTAINER_RUNTIME% push %REGISTRY_URL%/%REGISTRY_NAMESPACE%/spring-petclinic-buildstage
